# Configuration file to reference for jupyterhub.
# Generated from jupyterhub --generate-config
# ------------------------------------------------------------------------------
...
#  Default: '/srv/venv/share/jupyterhub'
# c.JupyterHub.data_files_path = '/srv/venv/share/jupyterhub'
...
#          .. versionadded:: 5.4
#  Default: False
# c.Authenticator.refresh_pre_stop = False
...
## Force refresh of auth prior to stop.
#  See also: Authenticator.refresh_pre_stop
# c.DummyAuthenticator.refresh_pre_stop = False
...
#              It may be async.
#  Default: traitlets.Undefined
# c.Spawner.ssl_alt_names = traitlets.Undefined
...
# c.LocalProcessSpawner.ssl_alt_names = traitlets.Undefined
...
## List of SSL alt names (list of strings).
#  See also: Spawner.ssl_alt_names
# c.SimpleLocalProcessSpawner.ssl_alt_names = traitlets.Undefined
...
## Force refresh of auth prior to stop.
#  See also: Authenticator.refresh_pre_stop
# c.NullAuthenticator.refresh_pre_stop = False
...
## Force refresh of auth prior to stop.
#  See also: Authenticator.refresh_pre_stop
# c.LocalAuthenticator.refresh_pre_stop = False
...
## Force refresh of auth prior to stop.
#  See also: Authenticator.refresh_pre_stop
# c.PAMAuthenticator.refresh_pre_stop = False
...
## Force refresh of auth prior to stop.
#  See also: Authenticator.refresh_pre_stop
# c.SharedPasswordAuthenticator.refresh_pre_stop = False
